...
public:
  ...
  double get_total_discovered_significance()
    const{ return landscape.get_total_discovered_significance(); };
  ...
  void add_significance(const int num_peak, const double add_noise);
};
